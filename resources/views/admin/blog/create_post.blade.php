...
@section('content')
  <div class="container">
    ...
    <form class="" action="{{route('admin.blog.create.post')}}" method="post">
      ...
      <div class="input-group">
        ...
        <textarea name="body" id="body" rows="12" cols="80"  {{$errors->has('body') ? 'class=has-error': ''}}>{{Request::old('body')}}</textarea>
      </div>
